...
public class SeeEliminate {
	...
	/**
	 * @param taskxiaoqueUser
	 *            the taskxiaoqueUser to set
	 */
	...
	/**
	 * @param taskfuzeUserIdea
	 *            the taskfuzeUserIdea to set
	 */
	...
	/**
	 * @param taskxiafaUserIdea
	 *            the taskxiafaUserIdea to set
	 */
	...
	/**
	 * @param taskCompletionDesc
	 *            the taskCompletionDesc to set
	 */
	...
	public String toString() {
		return "SeeEliminate [id=" + id + ", taskCoding=" + taskCoding + ", taskId=" + taskId + ", taskName=" + taskName
				+ ", taskStatus=" + taskStatus + ", taskBills=" + taskBills + ", taskxiafaUser=" + taskxiafaUser
				+ ", taskxiafaDate=" + taskxiafaDate + ", taskfuzeId=" + taskfuzeId + ", taskfuzeUser=" + taskfuzeUser
				+ ", taskDesc=" + taskDesc + ", taskxiaoqueUser=" + taskxiaoqueUser + ", taskfinishDate="
				+ taskfinishDate + ", taskfuzeUserIdea=" + taskfuzeUserIdea + ", taskxiafaUserIdea=" + taskxiafaUserIdea
