...
<body>
	...
	<input value="${save_eliminateId}" id="fuze_save_eliminateId" type="hidden"/>
	<table class="hovertable" style="border: 1px solid #ccc;margin-left: 120px;margin-top:20px;width:800px;height:300px;">
	   ...
	   <c:forEach items="${userList}" var="l">
		...
		<tr  >
			...
			<td style="border: 1px solid #ccc;">
			<textarea cols="30" rows="5" id="fuze_receipte">${seeEliminate.taskfuzeUserIdea}</textarea></td>
			<td style="border: 1px solid #ccc;font-size: 14px;font-weight: bold;" class="tdstyle">完成情况描述</td>
			<td style="border: 1px solid #ccc;">
			<textarea cols="30" rows="5" id="success_desc">${seeEliminate.taskCompletionDesc}</textarea></td>
		</tr>
		<tr  >
	...
	<a href="javascript:onclick=save_receipte_fuze()" class="easyui-linkbutton"
