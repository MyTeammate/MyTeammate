		...
		columns : [ [ {
			...
			formatter:function(value,row){
				...
				if (row.state==0) {
					...
					oper='<span><a href="javascript:updateFlaw('+row.id+')" style="text-decoration:none;">修改</a>｜<a href="javascript:cancelInspection('+row.id+')" style="text-decoration:none;">删除</a></span>';
				}
				return oper;
			}
		}, ] ],
