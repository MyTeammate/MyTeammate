...
<body>
	...
	<input value="${save_eliminateId}" id="xiafa_save_eliminateId" type="hidden"/>
	<table class="hovertable" style="border: 1px solid #ccc;margin-left: 120px;margin-top:20px;width:800px;height:300px;">
	   ...
	   <c:forEach items="${userList}" var="l">
		...
		<tr  >
			...
			<td style="border: 1px solid #ccc;">
			<textarea cols="30" rows="5" id="fuze_receipte" readonly="readonly">${seeEliminate.taskfuzeUserIdea}</textarea></td>
	...
	<a href="javascript:onclick=save_receipte_xiafa()" class="easyui-linkbutton"
