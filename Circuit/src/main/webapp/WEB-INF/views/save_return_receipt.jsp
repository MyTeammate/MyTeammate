...
<body>
	<div style="padding-left: 20px; padding-top: 15px">消缺任务管理>>消缺任务执行与回执>>回执录入</div>
	<hr />
	...
	<input value="${save_eliminateId}" id="save_eliminateId" type="hidden"/>
	...
	<a href="javascript:onclick=save_receipte()" class="easyui-linkbutton"
